     ...
     return (
          <TabGroup>
               ...
               {/* <div className={s.header}>
                    <TabTitle title="Tab 1" id={"first"} setActiveTab={setActiveTab} isActive={activeTab === "first"} />
                    <TabTitle title="Tab 2" id={"second"} setActiveTab={setActiveTab} isActive={activeTab === "second"} />
                    <TabTitle title="Tab 3" id={"third"} setActiveTab={setActiveTab} isActive={activeTab === "third"} />
               </div>
               <div className={s.main}>
                    <TabBody isActive={activeTab === "first"}>
                         <img className={s.image} src={"https://picsum.photos/id/200/500/500"} alt="Pic" />
                         <p className={s.text}>The #1 app to watch, clip, and share your awesome gaming moments with your friends and the world! </p>
                         <div className={s.links}>
                              {links.map((link) => (
                    ...
                    <TabBody isActive={activeTab === "second"}>
                         <img className={s.image} src={"https://picsum.photos/id/201/500/500"} alt="Pic" />
                         <p className={s.text}>With our world-class tools, we make it incredibly easy to share your videos. Get started today! </p>
                    </TabBody>
                    <TabBody isActive={activeTab === "third"}>
                         <img className={s.image} src={"https://picsum.photos/id/202/500/500"} alt="Pic" />
                         <p className={s.text}>
                              Damn this shit slaps 😳 . Its kinda unfair that not many people recognise and appreciate Jeshi but I just hope he doesn't quit and
                              im pretty sure he won't cus he doing it for his love for music and not just for money and clout . My man's gonna shock the whole
                              world very soon . Big ups to you my brother.
                         </p>
                    </TabBody>
               </div> */}
          </TabGroup>
